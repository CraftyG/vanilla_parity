...
execute if entity @s[predicate=vnla_prt:entity/wither_half_health,predicate=vnla_prt:chance/0.1807_pct,nbt=!{NoAI:1b}] at @s run function vnla_prt:world/wither/prepare_dash
