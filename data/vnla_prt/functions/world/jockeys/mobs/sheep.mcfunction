...
tp @s @e[type=sheep,limit=1,distance=..3,sort=nearest,tag=!vp.jockeyHost]
tag @e[type=sheep,limit=1,distance=..3,sort=nearest,tag=!vp.jockeyHost] add vp.jockeyHost
# summon the jockey, depending on the zombie
execute if entity @s[type=zombie] run summon sheep ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:zombie",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
execute if entity @s[type=husk] run summon sheep ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:husk",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
execute if entity @s[type=zombie_villager] run summon sheep ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:zombie_villager",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
...
execute as @e[tag=vp.jockeyVehicle] at @s run data modify entity @s Color set from entity @e[tag=vp.jockeyHost,limit=1,sort=nearest] Color
