...
tp @s @e[type=donkey,limit=1,distance=..3,sort=nearest,tag=!vp.jockeyHost]
tag @e[type=donkey,limit=1,distance=..3,sort=nearest,tag=!vp.jockeyHost] add vp.jockeyHost
# summon the jockey, depending on the zombie
execute if entity @s[type=zombie] run summon donkey ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:zombie",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
execute if entity @s[type=husk] run summon donkey ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:husk",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
execute if entity @s[type=zombie_villager] run summon donkey ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:zombie_villager",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
