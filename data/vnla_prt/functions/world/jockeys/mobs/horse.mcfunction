...
tp @s @e[type=horse,limit=1,distance=..3,sort=nearest,tag=!vp.jockeyHost]
tag @e[type=horse,limit=1,distance=..3,sort=nearest,tag=!vp.jockeyHost] add vp.jockeyHost
# summon the jockey, depending on the zombie
execute if entity @s[type=zombie] run summon horse ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:zombie",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
execute if entity @s[type=husk] run summon horse ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:husk",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
execute if entity @s[type=zombie_villager] run summon horse ~ ~ ~ {Tags:["vp.jockeyVehicle"],Passengers:[{id:"minecraft:zombie_villager",IsBaby:1b,Tags:["vp.jockeyPassenger"]}]}
...
execute as @e[tag=vp.jockeyVehicle] at @s run data modify entity @s Attributes[0] set from entity @e[tag=vp.jockeyHost,limit=1,sort=nearest] Attributes[0]
execute as @e[tag=vp.jockeyVehicle] at @s run data modify entity @s Attributes[1] set from entity @e[tag=vp.jockeyHost,limit=1,sort=nearest] Attributes[1]
execute as @e[tag=vp.jockeyVehicle] at @s run data modify entity @s Attributes[4] set from entity @e[tag=vp.jockeyHost,limit=1,sort=nearest] Attributes[4]
...
execute as @e[tag=vp.jockeyVehicle] at @s run data modify entity @s SaddleItem set from entity @e[tag=vp.jockeyHost,limit=1,sort=nearest] SaddleItem
