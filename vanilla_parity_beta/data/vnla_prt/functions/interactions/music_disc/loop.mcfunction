...
execute as @e[tag=vp.musicDisc] at @s if block ~ ~ ~ minecraft:jukebox{RecordItem:{id:"minecraft:music_disc_ward"}} run particle minecraft:note ~0.5 ~1.5 ~0.5 0 0 0 5 0
	# teal note
execute as @e[tag=vp.musicDisc] at @s if block ~ ~ ~ minecraft:jukebox{RecordItem:{id:"minecraft:music_disc_otherside"}} run particle minecraft:note ~0.5 ~1 ~0.5 0.8 0 0 1 0
	# blue note
