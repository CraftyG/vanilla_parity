...
execute as @e[tag=vp.musicDisc] at @s if block ~ ~ ~ minecraft:jukebox{RecordItem:{id:"minecraft:music_disc_otherside"}} run scoreboard players set @s vp.musicDiscTime 193
