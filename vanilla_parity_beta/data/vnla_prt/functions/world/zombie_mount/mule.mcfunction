...
execute as @e[tag=vp.targetPsgr] at @s run tp @s @e[type=mule,limit=1,distance=..3,sort=nearest]
execute as @e[tag=vp.targetPsgr] at @s run tag @e[type=mule,limit=1,distance=..1] add vp.targetVhcl
# summon jockey
execute as @e[type=husk,tag=vp.targetPsgr] at @s run summon mule ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:husk",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
execute as @e[type=zombie,tag=vp.targetPsgr] at @s run summon mule ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:zombie",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
execute as @e[type=zombie_villager,tag=vp.targetPsgr] at @s run summon mule ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:zombie_villager",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
