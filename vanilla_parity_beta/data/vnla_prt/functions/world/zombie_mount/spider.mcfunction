...
execute as @e[tag=vp.targetPsgr] at @s run tp @s @e[type=spider,limit=1,distance=..2,sort=nearest]
execute as @e[tag=vp.targetPsgr] at @s run tag @e[type=spider,limit=1,distance=..1] add vp.targetVhcl
# summon jockey
execute as @e[type=husk,tag=vp.targetPsgr] at @s run summon spider ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:husk",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
execute as @e[type=zombie,tag=vp.targetPsgr] at @s run summon spider ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:zombie",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
execute as @e[type=zombie_villager,tag=vp.targetPsgr] at @s run summon spider ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:zombie_villager",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
...
execute as @e[tag=vp.jockeyVhcl] at @s run data modify entity @s ActiveEffects set from entity @e[tag=vp.targetVhcl,limit=1,sort=nearest] ActiveEffects
