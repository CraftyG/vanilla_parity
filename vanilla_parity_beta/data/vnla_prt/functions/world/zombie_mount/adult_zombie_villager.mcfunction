...
execute as @e[tag=vp.targetPsgr] at @s run tp @s @e[type=zombie_villager,nbt={IsBaby:0b},limit=1,distance=..3,sort=nearest]
execute as @e[tag=vp.targetPsgr] at @s run tag @e[type=zombie_villager,nbt={IsBaby:0b},limit=1,distance=..1,sort=nearest] add vp.targetVhcl
# summon jockey
execute as @e[type=husk,tag=vp.targetPsgr] at @s run summon zombie_villager ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:husk",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
execute as @e[type=zombie,tag=vp.targetPsgr] at @s run summon zombie_villager ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:zombie",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
execute as @e[type=zombie_villager,tag=vp.targetPsgr] at @s run summon zombie_villager ~ ~ ~ {Tags:["vp.jockeyVhcl"],Passengers:[{id:"minecraft:zombie_villager",IsBaby:1b,Tags:["vp.jockeyPsgr"]}]}
...
execute as @e[tag=vp.jockeyVhcl] at @s run data modify entity @s HandItems set from entity @e[tag=vp.targetVhcl,limit=1,sort=nearest] HandItems
...
execute as @e[tag=vp.jockeyVhcl] at @s run data modify entity @s VillagerData set from entity @e[tag=vp.targetVhcl,limit=1,sort=nearest] VillagerData
